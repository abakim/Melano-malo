...
# =============================================================================
#  PROBADO RÁPIDO
# (COMENTAR LAS LÍNEAS 26 a 70 si se quiere usar este método y descomentar líneas 
# 79 y 82 para malignos o 80 y 83 para benignos)
# =============================================================================
## Cargado de conjunto de imagenes de una carpeta (solo una vez, formato jpg)

#malignos = func.load_images("banco de imagenes/malignas")
#benignos = func.load_images("banco de imagenes/benignas")
